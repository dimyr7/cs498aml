...
## Data preprocessinrotated_working_setg
...
for label_i in range(num_labels):
    ...
    centered_working_set = get_centered_working_set(working_set, label_i)
    eigen_vec = get_sorted_eigvec(centered_working_set)
