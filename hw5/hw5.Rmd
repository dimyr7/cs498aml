...
get_deviance <- function(model) {
  best_lambda_i <- which(model$glmnet.fit$lambda == default.lm_cv.lasso$lambda.min)
...
print(c("Best lambda's deviace for Lasso: ", get_deviance(default.lm_cv.lasso)))
...
print(c("Best lambda's deviace for Ridge: ", get_deviance(default.lm_cv.ridge)))
...
print(c("Best lambda's deviace for Elastic: ", get_deviance(default.lm_cv.elastic)))
